...
public class CalendarAvailability {
    ...
    private int isParttimeMonday;
    private int isParttimeTuesday;
    private int isParttimeWednesday;
    private int isParttimeThursday;
    private int isParttimeFriday;
    ...
    public int getIsParttimeMonday() {
        return isParttimeMonday;
    }

    public int getIsParttimeTuesday() {
        return isParttimeTuesday;
    }

    public int getIsParttimeWednesday() {
        return isParttimeWednesday;
    }

    public int getIsParttimeThursday() {
        return isParttimeThursday;
    }

    public int getIsParttimeFriday() {
        return isParttimeFriday;
    }

    public int getIsParttimeSaturday() {
        return isParttimeSaturday;
    }

    public int getIsParttimeSunday() {
        return isParttimeSunday;
    }
}

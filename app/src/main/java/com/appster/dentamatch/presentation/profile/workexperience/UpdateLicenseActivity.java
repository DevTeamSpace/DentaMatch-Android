...
public class UpdateLicenseActivity extends BaseActivity implements View.OnClickListener {
    ...
    private LicenseRequest prepareLicenceRequest() {
        processToShowDialog();
        LicenseRequest licenseRequest = new LicenseRequest();
        licenseRequest.setLicense(mBinder.etLicence.getText().toString());
        licenseRequest.setState(mBinder.etState.getText().toString());
        return licenseRequest;
    }

    private void callLicenceApi(LicenseRequest licenseRequest) {
        try {
            AuthWebServices webServices = RequestController.createService(AuthWebServices.class, true);
            webServices.updateLicence(licenseRequest).enqueue(new BaseCallback<LicenseUpdateResponse>(UpdateLicenseActivity.this) {
                @Override
                public void onSuccess(LicenseUpdateResponse response) {
                ...
                @Override
                public void onFail(Call<LicenseUpdateResponse> call, BaseResponse baseResponse) {

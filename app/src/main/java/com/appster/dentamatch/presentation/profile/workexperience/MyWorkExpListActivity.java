...
public class MyWorkExpListActivity extends BaseLoadingActivity<MyWorkExpListViewModel>
        implements View.OnClickListener, JobTitleSelectionListener, YearSelectionListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel.getWorkExperience().observe(this, this::onSuccessAddWorkExperience);

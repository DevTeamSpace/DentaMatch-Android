...
import com.appster.dentamatch.utils.CameraUtil;
import com.appster.dentamatch.utils.Constants;
import com.appster.dentamatch.utils.PermissionUtils;
...
//                findViewById(R.id.android_material_design_spinner);
            ...
            case R.id.create_profile1_btn_not_now:
                ...
                Alert.createYesNoAlert(CreateProfileActivity1.this, getString(R.string.ok), getString(R.string.cancel), "", getString(R.string.alert_profile), new Alert.OnAlertClickListener() {
                    ...
                    public void onPositive(DialogInterface dialog) {
                        Util.showToast(CreateProfileActivity1.this,"Comming soon....");
                    }
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.CAMERA)) {
                Snackbar.make(mBinder.createProfile1IvProfileIcon, getResources().getString(R.string.text_camera_permision),
                        ...
                        .setAction("OK", new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                PermissionUtils.requestPermission(CreateProfileActivity1.this, new String[]{Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE}, Constants.REQ_CODE_CAMERA);
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                Snackbar.make(mBinder.createProfile1IvProfileIcon, this.getResources().getString(R.string.text_camera_permision),
                        ...
                        .setAction(getString(R.string.accept), new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                PermissionUtils.requestPermission(CreateProfileActivity1.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE}, Constants.REQ_CODE_GALLARY);

                            }
                        }).show();
            } else {
                PermissionUtils.requestPermission(this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE}, Constants.REQ_CODE_GALLARY);
            }
        }
    ...
    public void takePhoto() {
        ...
        startActivityForResult(cameraIntent, Constants.REQ_CODE_CAMERA);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            } else if (requestCode == Constants.REQ_CODE_GALLARY) {

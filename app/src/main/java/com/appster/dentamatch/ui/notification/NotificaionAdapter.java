 ...
 */
public class NotificaionAdapter extends RecyclerView.Adapter<NotificaionAdapter.MyHolder> implements View.OnClickListener, View.OnLongClickListener {
    private ItemNotificationBinding mBinding;
    private Context mContext;
    private ArrayList<HiredJobs> mJobListData = new ArrayList<>();


    public NotificaionAdapter(Context context) {
        mContext = context;
    }

 ...
 */
public class SchoolAutocompleteAdapter
        extends ArrayAdapter<School> implements Filterable {

    private static final String TAG = "SchoolAutocompleteAdapter";
    private static final CharacterStyle STYLE_BOLD = new StyleSpan(Typeface.BOLD);
    /**
     * Current results returned by this adapter.
     */
    private ArrayList<School> mResultList;
     ...
     */
    public SchoolAutocompleteAdapter(Context context, GoogleApiClient googleApiClient,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        textView1.setText(item.getSchoolName());
...
//                    filterData = getAutocomplete(constraint);
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                if (results != null && results.count > 0) {
                    ...
                    mResultList = (ArrayList<School>) results.values;
     ...
     */
    private ArrayList<School> getAutocomplete(CharSequence constraint) {
